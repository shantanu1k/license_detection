...
class SingleMatching{
  ...
  num _matchpercent(String knownLicense,String foundLicense){
    knownLicense = _comparableFormOf(knownLicense);
  ...
  void detectLicense(String foundLicense){
    ...
    print("${max.toStringAsPrecision(4)}% match with '$highestMatch'");
  }
}
